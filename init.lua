...
require("lazy").setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>ss", builtin.lsp_dynamic_workspace_symbols, { desc = "Search symbols" })
  ...
  { "Bilal2453/luvit-meta", lazy = true },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        zls = {},
        --
        -- INSTALL PYLSP FROM WITHIN VIRTUAL ENVIRONMENT instead of HERE!!!
        --
        -- -- pythonn lsp
        -- pyright = {
        --   settings = {
  ...
  require("kickstart.plugins.opencode-nvim"),
